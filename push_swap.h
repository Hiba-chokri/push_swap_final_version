...
/*   Updated: 2024/04/04 16:07:06 by hichokri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					calculate_cost(t_stack *a, t_stack *b, int node,
						int target);
...
int					calculate_cost1(t_stack *a, t_stack *b, int node,
						int target);
void				ft_error(void);
void				calculate_best_target_b_to_a(t_stack **a, long *best_target,
						int *node);
